...
class WebPrinter():
    ...
    def formFeed(self):
        '''This commands prints all data collected in the printer buffer In page mode. After completion of printing, the printer isreturned to standard mode.'''
...
class QRcode():
    ...
    def setSize(self,size=3):
        ...
        self.size=size
    def setErrorCorrectionLevel(self,eqr):
        ''' variating from 48 to 51'''
        self.errorCorrectionLevel=eqr
    def applyModel(self):
    ...
    def applyErrorCorrectionLevel(self):
        ...
        self.P.send(bytearray([self.errorCorrectionLevel]))
